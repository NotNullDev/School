...
00000000000010e0 <_start>:
    ...
    10f1:	50                   	push   %rax
    10f2:	54                   	push   %rsp
    10f3:	4c 8d 05 36 02 00 00 	lea    0x236(%rip),%r8        # 1330 <__libc_csu_fini>
    10fa:	48 8d 0d bf 01 00 00 	lea    0x1bf(%rip),%rcx        # 12c0 <__libc_csu_init>
...
00000000000011c9 <main>:
    ...
    11f0:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%rbp)
    11f7:	e9 96 00 00 00       	jmpq   1292 <main+0xc9>
    11fc:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    1203:	eb 79                	jmp    127e <main+0xb5>
    1205:	e8 c6 fe ff ff       	callq  10d0 <rand@plt>
    120a:	89 c2                	mov    %eax,%edx
    120c:	48 63 c2             	movslq %edx,%rax
    120f:	48 69 c0 67 66 66 66 	imul   $0x66666667,%rax,%rax
    1216:	48 c1 e8 20          	shr    $0x20,%rax
    121a:	89 c1                	mov    %eax,%ecx
    121c:	c1 f9 02             	sar    $0x2,%ecx
    121f:	89 d0                	mov    %edx,%eax
    1221:	c1 f8 1f             	sar    $0x1f,%eax
    1224:	29 c1                	sub    %eax,%ecx
    1226:	89 c8                	mov    %ecx,%eax
    1228:	c1 e0 02             	shl    $0x2,%eax
    122b:	01 c8                	add    %ecx,%eax
    122d:	01 c0                	add    %eax,%eax
    122f:	89 d1                	mov    %edx,%ecx
    1231:	29 c1                	sub    %eax,%ecx
    1233:	f3 0f 2a c1          	cvtsi2ss %ecx,%xmm0
    1237:	8b 45 dc             	mov    -0x24(%rbp),%eax
    123a:	48 98                	cltq   
    123c:	8b 55 d8             	mov    -0x28(%rbp),%edx
    123f:	48 63 d2             	movslq %edx,%rdx
    1242:	48 01 d2             	add    %rdx,%rdx
    1245:	48 01 d0             	add    %rdx,%rax
    1248:	f3 0f 11 44 85 e0    	movss  %xmm0,-0x20(%rbp,%rax,4)
    124e:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1251:	48 98                	cltq   
    1253:	8b 55 d8             	mov    -0x28(%rbp),%edx
    1256:	48 63 d2             	movslq %edx,%rdx
    1259:	48 01 d2             	add    %rdx,%rdx
    125c:	48 01 d0             	add    %rdx,%rax
    125f:	f3 0f 10 44 85 e0    	movss  -0x20(%rbp,%rax,4),%xmm0
    1265:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1269:	48 8d 3d 9b 0d 00 00 	lea    0xd9b(%rip),%rdi        # 200b <_IO_stdin_used+0xb>
    1270:	b8 01 00 00 00       	mov    $0x1,%eax
    1275:	e8 46 fe ff ff       	callq  10c0 <printf@plt>
    127a:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    127e:	83 7d dc 01          	cmpl   $0x1,-0x24(%rbp)
    1282:	7e 81                	jle    1205 <main+0x3c>
    1284:	bf 0a 00 00 00       	mov    $0xa,%edi
    1289:	e8 02 fe ff ff       	callq  1090 <putchar@plt>
    128e:	83 45 d8 01          	addl   $0x1,-0x28(%rbp)
    1292:	83 7d d8 01          	cmpl   $0x1,-0x28(%rbp)
    1296:	0f 8e 60 ff ff ff    	jle    11fc <main+0x33>
    129c:	b8 00 00 00 00       	mov    $0x0,%eax
    12a1:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    12a5:	64 48 33 34 25 28 00 	xor    %fs:0x28,%rsi
    12ac:	00 00 
    12ae:	74 05                	je     12b5 <main+0xec>
    12b0:	e8 fb fd ff ff       	callq  10b0 <__stack_chk_fail@plt>
    12b5:	c9                   	leaveq 
    12b6:	c3                   	retq   
